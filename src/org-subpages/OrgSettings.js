...
export default function OrgSettings(props) {
  return (
    <ErrorBoundary>
      ...
      >
        <Box padding={2}>
          <CustomAccordion title={"Permissions"}>Contents</CustomAccordion>
          <CustomAccordion title={"Roles"}>Contents</CustomAccordion>
          ...
          <CustomAccordion title={"Payments"}>
            AgendaRaven is currently free, but in order to keep operating costs
            down, it is necessary to restrict the use of certain services. These
            are shown below.
          </CustomAccordion>
        </Box>
      </AdminCheck>
