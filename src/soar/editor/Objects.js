    ...
    >
      ...
      >
        ...
        <MenuItem onClick={handleDelete}>
          <DeleteForeverOutlined sx={{ mr: 1, ml: 0 }} /> Delete
        </MenuItem>
        <MenuItem
          onClick={() => {
            setFormOpen(true);
        ...
        >
          <Category sx={{ mr: 1, ml: 0 }} /> Type:{" "}
          {props.cats && props.item ? props.cats[props.item] : "NONE"}
        </MenuItem>
        {props.cats && props.item
          ? props.cats[props.item] === "time"
            ? [
                ...
                >
                  <PunchClock sx={{ mr: 1, ml: 0 }} /> Set all to AM
                </MenuItem>,
                <MenuItem
                  key={"PM"}
                  onClick={() => {
                ...
                >
                  <PunchClock sx={{ mr: 1, ml: 0 }} /> Set all to PM
                </MenuItem>,
              ]
            : ""
          : ""}
  ...
  return (
    <div>
      ...
      >
        ...
        <MenuItem onClick={handleDelete} sx={{ minWidth: "100px" }}>
          <DeleteForeverOutlined sx={{ mr: 1, ml: 0 }} />
          Delete
        </MenuItem>
      </Menu>
    </div>
...
export function DraggablePerson(props) {
  function onDrag() {
    props.setHighlight(
      getPeopleHighlight(props.people[props.person].uid, props)
    );
  }
