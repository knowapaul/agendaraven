...
export default function Account(props) {
    ...
    return (
        <Box height={{xs: 'calc(100% - 56px)', md: 'calc(100% - 64px)'}} overflow='auto'>
            <Button 
            ...
            <Tooltip title={changing ? '' : "Click 'Edit' to make modfications"}>
                <Box padding={2} sx={{backgroundColor: changing ? '' : 'rgba(0, 0, 0, .25)' }}>
                    ...
                    <Typography variant="subtitle2" sx={{pb: 2}}>
                        This will not change past organization's schedule names. You can do that in the organization's settings tab.
                    </Typography>
                    <TextField 
                    value={sch}
                    label={'Schedule Name'}
                    ...
                    helperText={cPass && pass.length < 9 ? 'Passwords must be longer than 8 characters' : ''}                    
                    onBlur={() => {setCPass(true)}}
                    type='password'
                    />
                    <TextField 
                    value={conf}
                    ...
                    helperText={cConf && pass !== conf ? 'Passwords must be identical' : ''}
                    onBlur={() => {setCConf(true)}}
                    type='password'
                    />
                    <Button 
                    variant="contained"
