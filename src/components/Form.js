...
class Input extends React.Component {
  constructor(props) {
    super(props);
    const errorState =
      this.props.required && !this.props.data[cleanName(this.props.name)];
    this.state = {
      check: false,
      error: errorState,
    ...
    this.props.setErrors(
      Object.assign(this.props.errors, { [this.props.name]: errorState })
    );
  ...
  handleChange(event) {
    ...
    this.props.setErrors(
      Object.assign(this.props.errors, { [this.props.name]: error })
    );
    ...
    this.props.setData(
      Object.assign(this.props.data, {
        [cleanName(this.props.name)]: prunedValue,
      })
    );
  }
  ...
  render() {
    const error =
      this.props.validate === "confirm" &&
      this.props.password !== this.state.value;
    ...
    return (
      <TextField
        ...
        error={
          (this.state.check || this.props.check) && (this.state.error || error)
        }
